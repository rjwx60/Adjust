      ...
      v = function (e, t) {
        ...
        function Q(e, t, n) {
          ...
          var s = function (e) {
            ...
            console.log(r, s);
            if (r == 0) o = c.up;
            else if (r == 1) o = c.home;
            else if (s > C && T[s] == "\n") o = c.end;
            else if (r < N && T[r - 1] == " ") (o = c.left), (u = h.option);
            else if (r < N || (r == N && C != N && r == s)) o = c.left;
            else if (s > C && T.slice(0, s).split("\n").length > 2) o = c.down;
            else if (s > C && T[s - 1] == " ") (o = c.right), (u = h.option);
            else if (s > C || (s == C && C != N && r == s)) o = c.right;
            r !== s && (u |= h.shift),
              o && (t.onCommandKey(null, u, o), (N = r), (C = s), A(""));
          };
        ...
        r.addListener(n, "blur", function (e) {
          ...
          (this.$focusScroll = !1),
          (this.focus = function () {
            if (b || f || this.$focusScroll == "browser")
          ...
          : function () {
              ...
              u.length > l &&
                (s < l && o < l
                  ...
                  : ((u = "\n"), (s = 0), (o = 1)));
              var c = u + "\n\n";
              c != T && ((n.value = T = c), (N = C = c.length)),
                D && ((N = n.selectionStart), (C = n.selectionEnd));
              if (C != o || N != s || n.selectionEnd != C)
                try {
        ...
        r.addCommandKeyListener(n, t.onCommandKey.bind(t)),
          r.addListener(n, "select", M),
          r.addListener(n, "input", H),
          r.addListener(n, "cut", F),
          r.addListener(n, "copy", I),
          r.addListener(n, "paste", q),
        ...
        var R = function (e) {
            ...
            (r.end.row = r.start.row),
              ...
              (g.markerRange = r),
              (g.selectionStart = N),
              t.onCompositionStart(g),
              g.useTextareaForIME
                ? ((n.value = ""), (T = ""), (N = 0), (C = 0))
                : (n.msGetInputContext && (g.context = n.msGetInputContext()),
                  n.getInputContext && (g.context = n.getInputContext()));
          },
          U = function () {
            if (!g || !t.onCompositionUpdate || t.$readOnly) return;
            if (S) return W();
            if (g.useTextareaForIME) t.onCompositionUpdate(n.value);
            else {
              var e = n.value;
              P(e),
                g.markerRange &&
                  (g.context &&
                    (g.markerRange.start.column = g.selectionStart =
                      g.context.compositionStartOffset),
                  (g.markerRange.end.column =
                    g.markerRange.start.column + C - g.selectionStart));
            }
          },
          z = function (e) {
        ...
        r.addListener(n, "compositionstart", R),
          r.addListener(n, "compositionupdate", U),
          r.addListener(n, "keyup", V),
          r.addListener(n, "keydown", X),
          r.addListener(n, "compositionend", z),
          ...
          (this.moveToMouse = function (e, o) {
            ...
            (t.renderer.$isMousePressed = !0),
              clearTimeout($),
              i.isWin && r.capture(t.container, h, J);
          }),
        ...
        r.addListener(n, "mouseup", K),
          r.addListener(n, "mousedown", function (e) {
            e.preventDefault(), J();
          }),
          r.addListener(t.renderer.scroller, "contextmenu", K),
          r.addListener(n, "contextmenu", K),
          p && Q(e, t, n);
      };
    t.TextInput = v;
  }),
  ...
  define("ace/mouse/touch_handler", [
    ...
    t.addTouchListeners = function (e, t) {
      function m() {
        (a = null),
          clearTimeout(a),
          t.selection.isEmpty() && t.selection.moveToPosition(c),
          (n = "wait");
      }
      function g() {
        ...
        var e =
          h >= 2
            ? t.selection.getLineRange(c.row)
            : t.session.getBracketRange(c);
      ...
      function y() {
        (l += 60),
          (f = setInterval(function () {
            l-- <= 0 && (clearInterval(f), (f = null)),
              Math.abs(p) < 0.01 && (p = 0),
              Math.abs(d) < 0.01 && (d = 0),
              l < 20 && (p = 0.9 * p),
              l < 20 && (d = 0.9 * d),
              t.renderer.scrollBy(10 * p, 10 * d);
          }, 10));
      }
      var n = "scroll",
        i,
      ...
      e.addEventListener("contextmenu", function (e) {
        ...
        e.addEventListener("touchend", function (e) {
          (v = t.$mouseHandler.isMousePressed = !1),
            f && clearInterval(f),
            n == "zoom"
              ? ((n = ""), (l = 0))
              : a
              ? (t.selection.moveToPosition(c), (l = 0))
              : n == "scroll" && (y(), e.preventDefault()),
            clearTimeout(a),
            (a = null);
        }),
        e.addEventListener("touchmove", function (e) {
          ...
          if (n == "scroll") {
            ...
            (m.speed = 1),
              (m.wheelX = l),
              (m.wheelY = c),
              10 * Math.abs(l) < Math.abs(c) && (l = 0),
              10 * Math.abs(c) < Math.abs(l) && (c = 0),
              v != 0 && ((p = l / v), (d = c / v)),
              t._emit("mousewheel", m),
              m.propagationStopped || (p = d = 0);
          } else {
            var g = new r(e, t),
    ...
    (function () {
      (this.isBidiRow = function (e, t, n) {
        ...
        (this.updateCharacterWidths = function (e) {
          ...
          (this.charWidths[r.L] = this.charWidths[r.EN] = this.charWidths[
            r.ON_R
          ] = t),
        ...
        (this.getSelections = function (e, t) {
          ...
          if (this.isRtlDir)
            for (var d = 0; d < s.length; d++) s[d].left += this.rtlLineOffset;
          return s;
        }),
        ...
        (this.getLineTokens = function (e, t) {
          ...
          while ((a = u.exec(e))) {
            ...
            if (c++ > i) {
              ...
              while (l < e.length)
                h.type && f.push(h),
                  (h = { value: e.substring(l, (l += 500)), type: "overflow" });
              (r = "start"), (n = []);
              break;
            }
          }
          ...
          if (e.action == "insert") {
            ...
            for (; o < u; o++) {
              ...
              a.start.row == r &&
                ...
                (a.start.column != t.column || !this.$insertRight) &&
        ...
        r.implement(this, u),
          ...
          (this.$getUndoSelection = function (e, t) {
            ...
            for (var o = 0; o < e.length; o++) {
              ...
              if (!r) {
                n(u)
                  ? ((r = l.fromPoints(u.start, u.end)), (s = !0))
                  : ((r = l.fromPoints(u.start, u.start)), (s = !1));
                continue;
              }
              n(u)
                ? ((i = u.start),
  ...
  define("ace/editor", [
    ...
    var E = {
      ...
      getWidth: function (e, t, n) {
        return (
          Math.max(t.toString().length, (n.lastRow + 1).toString().length, 2) *
          n.characterWidth
        );
      },
      update: function (e, t) {
      ...
      r.implement(this, u),
        ...
        (this.onChangeTabSize = this.$computeTabString = function () {
          ...
          for (var n = 1; n < e + 1; n++)
            if (this.showInvisibles) {
              ...
              t.push(
                this.dom.createTextNode(s.stringRepeat(" ", n), this.element)
              );
        ...
        (this.scrollLines = function (e) {
          ...
          if (t.lastRow > e.lastRow)
            for (
              var i = this.session.getFoldedRowCount(e.lastRow + 1, t.lastRow);
              i > 0;
              i--
            )
              this.$lines.pop();
          ...
          while ((a = o.exec(r))) {
            ...
            if (l) {
              ...
              (g.style.width = i.config.characterWidth * 2 + "px"),
                (g.className = i.showInvisibles
                  ? "ace_cjk ace_invisible ace_invisible_space"
                  : "ace_cjk"),
                (g.textContent = i.showInvisibles ? i.SPACE_CHAR : ""),
                u.appendChild(g);
            } else if (d) {
              t += 1;
              var g = this.dom.createElement("span");
      ...
      (this.CHANGE_CURSOR = 1),
        ...
        (this.$moveTextAreaToCursor = function () {
          ...
          if (!t) s += this.lineHeight;
            ...
            (a =
              this.characterWidth * this.session.$getStringScreenWidth(f)[0]),
              (u += 2);
        ...
        (this.$computeLayerConfig = function () {
          ...
          return (
            (this.layerConfig = {
              ...
              offset: d,
              gutterOffset: w
                ? Math.max(0, Math.ceil((d + t.height - t.scrollerHeight) / w))
                : 0,
